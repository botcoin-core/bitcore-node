...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the botcoin database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `botcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ botcore-node add wallet-service');
      console.log('    $ botcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ botcore-node remove wallet-service');
      console.log('    $ botcore-node remove insight-api');
      console.log();
    });
