...
var BASE_PACKAGE = {
  ...
  readme: 'README.md',
  dependencies: {
    'botcore-lib': '^' + botcore.version,
    'botcore-node': version
  }
};

/**
 * Will create a directory and botcoin.conf file for Bitcoin.
 ...
 * @param {String} options.datadir - The botcoin database directory
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/botcore-node.json', configJSON);
      if (!isGlobal) {
 ...
 * botcoin configuration, and will install all necessary dependencies.
 *
 * @param {Object} options
 * @param {String} options.cwd - The current working directory
 * @param {String} options.dirname - The name of the botcore node configuration directory
 * @param {String} options.datadir - The path to the botcoin datadir
...
function create(options, done) {
  ...
  async.series([
    function(next) {
      // Setup the the botcore-node directory and configuration
    ...
    function(next) {
      // Setup the botcoin directory and configuration
